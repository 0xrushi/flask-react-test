...
import SearchCard from './backtest-page-components/SearchCard';
import FilterCard from './backtest-page-components/FilterCard';
import TableDataCard from './backtest-page-components/TableDataCard';
import GraphCard from './backtest-page-components/GraphCard';
import './css/styles.css';

class Backtesthome extends React.Component{
